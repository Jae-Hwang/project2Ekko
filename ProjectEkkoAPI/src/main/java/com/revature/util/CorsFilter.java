...
public class CorsFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		logger.trace(httpRequest.getMethod() + " request going to " + httpRequest.getRequestURI());
		...
		// request headers
		// First being, 'Access-Control-Allow-Origin' with the value being the domain
		// you are requesting from
		httpResponse.addHeader("Access-Control-Allow-Origin", "http://localhost:4200");

		// The second being, 'Access-Control-Allow-Methods' with the HTTP Methods you
		// grant access to
		...
		httpResponse.addHeader("Access-Control-Allow-Headers",
				"Access-Control-Allow-Origin, Access-Control-Allow-Headers, Origin, Accept, X-Requested-With, Authorization, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, Access-Control-Allow-Credentials");
		httpResponse.addHeader("Access-Control-Expose-Headers", "X-test");
